...
#ifndef EXCHANGE_GOCIO_H
#define EXCHANGE_GOCIO_H

#include "exchange.h"

class Exchange_GOCio : public Exchange
{
	Q_OBJECT

public:
	Exchange_GOCio(QByteArray pRestSign, QByteArray pRestKey);
	~Exchange_GOCio();
